...
const AddCoffee = () => {
  const handleAddCoffee = (event) => {
    ...
    // axios post request to add coffee data
    axios
      .post("https://coffee-shop-backend-taupe.vercel.app/coffee", coffee)
      .then((res) => {
        // console.log(res);
        ...
        <div className="flex flex-col gap-7 py-10">
          <div className="flex flex-col md:flex-row items-center justify-center gap-7 px-10">
            <div className="w-full">
              ...
              <br />
              <input
                className="border-2 rounded-md py-2 px-2 w-full"
                type="text"
                name="name"
                id="coffeeName"
          ...
          <input
            type="submit"
            value="Add Coffee"
            className="btn bg-[#D2B48C] border-2 border-[#331A15] mx-10 font-secondary text-2xl"
          />
        </div>
      </form>
    </div>
